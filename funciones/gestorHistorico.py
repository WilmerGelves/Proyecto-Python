...
def createHistory():
    ...
    try:
        cedulaPaciente = int(input('Cédula del paciente: '))
        cedulaPaciente = str(cedulaPaciente)
        try:
            if cedulaPaciente in usuario.get('paciente').get(cedulaPaciente).get('cedula'):
                ...
                print(apellidoPaciente)
                print(edad)
                print(genero)
                globals.pausar_pantalla()
                identEspecialista = int(input('Indentificación del especialista: '))
                identEspecialista = str(identEspecialista)
